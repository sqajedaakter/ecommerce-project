        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('/product/store') }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Enter Product Brand Name</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sku" class="form-control" placeholder="Enter Product Quantity">
                    </div>
                    ...
                    <div class="form-group">
                        <label>Enter Product Sort Description</label>
