...
<div class="container-fluid py-5">
    <div class="row px-xl-5">
            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner border">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="{{ asset('public/Image/'.$productdetal->image) }}" alt="Image">
                    </div>
        ...
        <div class="col-lg-7 pb-5">
            <h3 class="font-weight-semi-bold">{{ $productdetal->name }}</h3>
            ...
            <h3 class="font-weight-semi-bold mb-4">${{ $productdetal->price }}</h3>
            <p class="mb-4">{{ $productdetal->short_description }}</p>
            <div class="d-flex align-items-center mb-4 pt-2">
                ...
                <form action="{{ url('add/to/cart/'.$productdetal->id )}}" method="POST">
                    @csrf
                    <input type="hidden" value="{{ $productdetal->id }}" name="product_id">
                    <input type="hidden" value="{{ $productdetal->price}}" name="price">
        ...
        <div class="col">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="tab-pane-1">
                    ...
                    <p>{{ $productdetal->long_description }}</p>
                </div>
